  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      <header className="mb-8">
        <h2 className="text-3xl font-bold text-white mb-2">Scene Search (Trace.moe)</h2>
        <p className="text-gray-400">Upload a screenshot or paste an image URL to find out which anime it's from.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg">
            <h3 className="text-lg font-semibold mb-4 flex items-center text-indigo-400">
              <LinkIcon className="mr-2" size={18} /> Search by URL
            </h3>
            <form onSubmit={handleUrlSubmit} className="flex space-x-2">
              ...
              <button 
                ...
                className="bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white px-4 py-2 rounded-lg transition-colors flex items-center"
              >
                <Search size={18} />
              </button>
            </form>
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg relative">
            ...
            <div className="border-2 border-dashed border-gray-600 rounded-xl p-8 text-center hover:border-purple-500 transition-colors cursor-pointer relative">
              ...
              />
              <ImageIcon className="mx-auto text-gray-500 mb-3" size={32} />
              <p className="text-gray-300 font-medium">Click or drag image here</p>
              <p className="text-xs text-gray-500 mt-2">JPEG, PNG, WEBP (Max 1MB for best results)</p>
            </div>
            ...
            {file && (
              <button 
                ...
                disabled={loading}
                className="w-full mt-4 bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white py-2 rounded-lg transition-colors flex justify-center items-center font-medium"
              >
        ...
        {/* Results Section */}
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg min-h-[400px] flex flex-col">
          <h3 className="text-lg font-semibold mb-4 border-b border-gray-700 pb-2">Results</h3>
          
          {error && (
            <div className="bg-red-900/50 border border-red-500 text-red-200 p-4 rounded-lg flex items-start mb-4">
          ...
          {preview && (
            <div className="mb-6">
              <p className="text-xs text-gray-400 mb-2 uppercase tracking-wide font-bold">Target Image</p>
              <img src={preview} alt="Target" className="w-full h-40 object-cover rounded-lg border border-gray-600" />
            </div>
          )}
          ...
          <div className="flex-1">
            {loading ? (
              <div className="h-full flex flex-col items-center justify-center text-gray-500 space-y-4 py-10">
                ...
                <p>Analyzing image across anime database...</p>
              </div>
            ) : results.length > 0 ? (
              <div className="space-y-6">
                {results.map((result, index) => (
                  <div key={index} className="bg-gray-900 rounded-lg p-4 border border-gray-700 flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex-1 space-y-2">
                      <h4 className="font-bold text-white text-lg">{result.filename || "Unknown"}</h4>
                      
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div className="bg-gray-800 p-2 rounded">
                          <p className="text-gray-500 text-xs">Episode</p>
              ...
              <div className="h-full flex items-center justify-center text-gray-600 py-10 text-center px-4">
